...
:  This attribute specifies the scale of the `value` column (see below). It is either a numeric scalar or `NA`. It is numeric only for objects with "value_type"s `r toString(ccmppWPP:::get_value_types_w_non_NA_value_scale())`.
