...
#' @export
subset_time.mig_net_count_input_df <- function(x, time, drop = FALSE) {
...
#' @rdname subset_demog_change_component_df
#' @export
subset_age.mig_net_count_input_df <- function(x, age, drop = FALSE) {
...
#' @rdname subset_demog_change_component_df
#' @export
subset_sex.mig_net_count_input_df <- function(x, sex, drop = FALSE) {
