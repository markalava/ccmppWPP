...
Note that the extra restrictions mean that the example given at the end of Section \@ref(data-component) is no long valid; there can be no age or time intervals missing.
