...
## save(S3_demog_change_component_time_age_sex_test_df,
##      file = "inst/testdata/S3_demog_change_component_time_age_sex_test_df.rda")

## S3_demog_change_component_time_age_test_df <-
##     subset(S3_demog_change_component_time_age_sex_test_df,
##            sex == "female", select = -sex)
## save(S3_demog_change_component_time_age_test_df,
##      file = "inst/testdata/S3_demog_change_component_time_age_test_df.rda")
