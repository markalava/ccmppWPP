...
#' @export
proj_pop_cpp <- function(step_size, pop_count_age_m_t0, pop_count_age_f_t0, surv_prop_age_m, surv_prop_age_f, fert_rate_age, net_mig_count_age_m, net_mig_count_age_f, srb_tot = 1.05, mig_assumption = "even") {
    .Call(`_ccmppWPP_proj_pop_cpp`, step_size, pop_count_age_m_t0, pop_count_age_f_t0, surv_prop_age_m, surv_prop_age_f, fert_rate_age, net_mig_count_age_m, net_mig_count_age_f, srb_tot, mig_assumption)
}
...
#' Preston, S. H., Heuveline, P., and Guillot, M. (2001), \emph{Demography: Measuring and Modeling Population Processes}, Malden, Massachusetts: Blackwell.
#' @export
proj_pop_cpp_sugar <- function(step_size, pop_count_age_m_t0, pop_count_age_f_t0, surv_prop_age_m, surv_prop_age_f, fert_rate_age, net_mig_count_age_m, net_mig_count_age_f, srb_tot = 1.05, mig_assumption = "even") {
    .Call(`_ccmppWPP_proj_pop_cpp_sugar`, step_size, pop_count_age_m_t0, pop_count_age_f_t0, surv_prop_age_m, surv_prop_age_f, fert_rate_age, net_mig_count_age_m, net_mig_count_age_f, srb_tot, mig_assumption)
}
